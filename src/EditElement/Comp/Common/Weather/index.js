...
class Weather extends React.Component {
	...
	render() {
		let { data, type,ioInputW } = this.props
		!ioInputW ? ioInputW = this.state : null
		let dom
		switch (type){
				case "Style1" : dom = (<RenderStyle1 props={this.props} con={data.data.content} weather={ioInputW.weather} />); break
				case "Style2" : dom = (<RenderStyle2 props={this.props} con={data.data.content} weather={ioInputW.weather} />); break
				case "Style3" : dom = (<RenderStyle3 props={this.props} con={data.data.content} weather={ioInputW.weather} />); break
				case "Style4" : dom = (<RenderStyle4 props={this.props} con={data.data.content} weather={ioInputW.weather} />); break
				case "Style5" : dom = (<RenderStyle5 props={this.props} con={data.data.content} weather={ioInputW.weather} />); break
				case "Style6" : dom = (<RenderStyle6 props={this.props} con={data.data.content} weather={ioInputW.weather} />); break
				case "Style7" : dom = (<RenderStyle7 props={this.props} con={data.data.content} weather={ioInputW.weather} />); break
				case "Style8" : dom = (<RenderStyle8 props={this.props} con={data.data.content} weather={ioInputW.weather} />); break
				case "Style9" : dom = (<RenderStyle9 props={this.props} con={data.data.content} weather={ioInputW.weather} />); break
			}
		return (
			<div className={`e-weather ${type}`}>
				{ !ioInputW.no_show ? dom : null }
			</div>
		)
	}
}
